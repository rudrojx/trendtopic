@include('Admin.Layout.header')
  ...
  <div class="container mx-auto p-4">
    <h1 class="text-3xl font-bold mb-4">New User's List</h1>
    ...
    <table class="w-full bg-white border border-gray-300">
      <thead>
        <tr class="bg-gray-200">          
          ...
          <th class="py-2 px-4 border-b border-gray-300">Github ID</th>        
          <th class="py-2 px-4 border-b border-gray-300">Google ID</th>                   
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="py-2 px-4 border-b border-gray-300">{{$item->github_id}}</td>         
          <td class="py-2 px-4 border-b border-gray-300">{{$item->google_id}}</td>          

        <td class="py-2 px-4 border-b border-gray-300">
          <a href="{{url('/usersdelete')}}/{{$item->id}}"><button class="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Trash</button></a>          
